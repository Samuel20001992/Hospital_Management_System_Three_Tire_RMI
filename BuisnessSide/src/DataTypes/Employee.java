...
public class Employee implements Serializable {
    ...
    public Employee(int id, String firstName, String middleName, String lastName, String sex, int age, int phoneNumber,
                    String email, String address, Date hiredDate, int salary, String jobType, String imageAddress, int departmentId,String password) {
        this.id = id;
        this.firstName = firstName;
        this.middleName = middleName;
        this.lastName = lastName;
    ...
    public String toString() {
        return "Employee{" + "id=" + id + ", firstName='" + firstName + '\'' + ", middleName='" + middleName + '\''
                ...
                + ", imageAddress='" + imageAddress + ", password='" + password +  '\'' + '}';
    }
