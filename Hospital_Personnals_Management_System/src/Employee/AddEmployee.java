...
public class AddEmployee   {
    ...
    private void add_employee() throws IOException {
        ...
        if(emailFld.getText() == " " || firstNameFld.getText()==""||lastNameFld.getText()==""
        ...
        Pattern pattern4 = Pattern.compile("[1-8]");
        ...
        Matcher salaryCheck = pattern1.matcher(salaryFld.getText());
        Matcher departmentCheck = pattern4.matcher(departmentFld.getText());
        ...
        try {
            outStream.writeObject("Add Employee");
        } catch (IOException ioException) {
            ioException.printStackTrace();
        }
