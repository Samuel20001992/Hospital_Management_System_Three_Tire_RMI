...
public class EditEmployee {
    ...
    private JFXPasswordField passwordFld = new JFXPasswordField();
   ...
   public void edit_employee_main()
   {
    ...
    public EditEmployee(int id, String firstName, String middleName, String lastName, String sex, int age, int phoneNumber,
                        ...
                        String imageAddress, Socket socket, ObjectInputStream inStream, ObjectOutputStream outStream){
        ...
        jobStatusFld.setPromptText(jobType);
        ...
        imageNameFld.setPromptText("IMAGE");
        gridPane.setHalignment(imageNameFld, HPos.LEFT);
        gridPane.add(imageNameFld,0,27);
        ...
        gridPane.add(passwordFld,0,29);
        passwordFld.setLabelFloat(true);
        passwordFld.setMinWidth(400);
        passwordFld.setText(imageAddress);
    ...
    public void edit() throws IOException {
        ...
        String passsword = passwordFld.getText();
       ...
       outStream.writeObject("Edit Employee");
