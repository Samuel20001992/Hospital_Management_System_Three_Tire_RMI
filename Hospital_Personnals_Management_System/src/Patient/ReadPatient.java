...
public class ReadPatient extends Stage {
    ...
    public ReadPatient(Socket socket, ObjectInputStream inStream, ObjectOutputStream outStream) {
        ...
        delete.setOnAction(e->{
            ObservableList<Patient> patient = patientTable.getItems();
            DeletePatient deletePatient = new DeletePatient(patient.get(0).getId(),socket,  inStream,  outStream);
            try {
        ...
        dignosis.setOnAction(e->{
                ...
                ReadFile readFile;
                try {
                    readFile = new ReadFile(patient.get(0).getId(),patient.get(0).getFirstName(),socket,  inStream,  outStream);
                    readFile.show();
        ...
        room.setOnAction(e->{
            ...
            Add_Room add_room = new Add_Room(patient.get(0).getId(),socket,  inStream,  outStream);
            add_room.show();
        ...
        add_appointment.setOnAction(e->{
            ObservableList<Patient> patient = patientTable.getSelectionModel().getSelectedItems();
Add_Appointment add_appointment1 = new Add_Appointment(patient.get(0).getId(),socket,  inStream,  outStream);
...
//,dignosis
        ...
        new Thread(()->{
            ...
            try {
                patientList = (List<Patient>) inStream.readObject();
            } catch (IOException e) {
                e.printStackTrace();
        ...
        btnSearch.setOnAction(e->{
            ...
            new Thread(()->{
                List<Patient> patientList = null;
                try {
                    outStream.writeObject("Search Patient");
        ...
        setResizable(false);
        this.setTitle("List of Patients");
        this.setScene(scene);
