...
public class Adminstrator_Access {
    ...
    public void adminstrator_access_main()
    {
        ...
        primaryStage.setTitle("Adminstration Access");
        scene.getStylesheets().add("style.css");
        primaryStage.show();
    }

    public Adminstrator_Access(Socket socket, ObjectInputStream inStream, ObjectOutputStream outStream) {
    ...
    private void initDrawer() {
       ...
       hBox.getChildren().addAll(l,drawerCloseBtn);
        ...
        addEmployeeBtn.setOnAction(e->{
            ...
            AddEmployee addEmployee = new AddEmployee(socket,inStream,outStream);
        ...
        readEmployeeBtn.setOnAction(e->{
            try {
                outStream.writeObject("Read Employee");
            } catch (IOException ioException) {
                ioException.printStackTrace();
            }
            ReadEmployee readEmployee = new ReadEmployee(socket,inStream,outStream);
            readEmployee.read_employee_main();
        });
