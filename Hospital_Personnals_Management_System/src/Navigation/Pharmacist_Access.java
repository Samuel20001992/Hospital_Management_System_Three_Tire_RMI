...
public class Pharmacist_Access {
    ...
    public void pharmacist_access_main()
    {
        Scene scene = new Scene(borderPane, 900, 600, Color.WHITE);
        primaryStage.setScene(scene);

        //  primaryStage.setResizable(false);
        primaryStage.setTitle("Pharmacist Access");
        primaryStage.show();
    }
    public Pharmacist_Access(Socket socket, ObjectInputStream inStream, ObjectOutputStream outStream) {
        this.socket = socket;
...
//       borderPane.setBottom(gridPane);
    ...
    private void initDrawer() {
        ...
        JFXButton prescriptions = new JFXButton("List of Prescription");
        ...
        forDrawer.add(prescriptions, 0, 6);
